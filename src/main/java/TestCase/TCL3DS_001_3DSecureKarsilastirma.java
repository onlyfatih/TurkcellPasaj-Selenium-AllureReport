...
public class TCL3DS_001_3DSecureKarsilastirma extends TestBase {
    protected final String productURL = ConfigReader.readDataInfo().getProperty("productURL");
    public TCL3DS_001_3DSecureKarsilastirma() throws IOException {
    }
    ...
    public void TCL3DS_001_3DSecureKarsilastirma() {
